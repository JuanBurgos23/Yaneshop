...
<head>
   ...
   <link rel="shortcut icon"
      href="{{ optional(optional(auth()->user())->empresa)->logo
          ? asset('storage/' . auth()->user()->empresa->logo)
          : 'https://www.google.com/images/branding/googleicon/2x/googleicon_color_272x272dp.png' }}" />
